import { Clock, ScanSearch, UserCheck, CheckCircle2, XCircle, PauseCircle } from "lucide-react";
...
export const STATUS_META = {
  ...
  pending: { label: "Pending", classes: "bg-amber-100 text-amber-700", dot: "#F59E0B", icon: PauseCircle },
